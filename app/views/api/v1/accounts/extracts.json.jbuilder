...
json.results @extracts do |extract|
  ...
  elsif extract.operation_type == Bank::Model::Extract.operation_types[:transfer_received] || extract.operation_type == Bank::Model::Extract.operation_types[:transfer_sent]
